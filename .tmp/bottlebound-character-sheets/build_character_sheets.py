...
QUICK_TEXT = {
    ...
    "Divine Shield": ("REACTION • SELF / ALLY • 3 PACES", "When an attack would affect them, prevent all of its damage and effects against that character."),
    ...
    "Misty Escape": ("REACTION • SELF", "When attacked, prevent all damage and effects against you, then immediately move up to 2 paces."),
    "Arcane Bolt": ("POWERFUL • ENEMY • 6 PACES • LOS", "Deal 1 automatic damage. No throw. Reactions can still prevent or modify it."),
    "Mirror Veil": ("REACTION • SELF", "When attacked, prevent all damage and effects from that attack against you."),
    ...
    "Deflecting Palm": ("REACTION • SELF • PHYSICAL HIT", "Prevent the ball’s damage and effects against you, then redirect that same ball toward the thrower."),
    "Second Wind": ("STANDARD • SELF", "Restore 1 HP, up to your maximum of 4 HP."),
    "Shield Wall": ("REACTION • SELF / ALLY • 2 PACES", "When an attack would affect them, reduce its damage against that character by 1."),
